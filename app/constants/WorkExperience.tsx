const experiences = [
  {
    ...
    highlights: [
      ...
      "Development and control of data ingestion and ETL with Cloud Storage and Python",
      "Use of Jenkins platform (Job Scheduler), maintaining flow consistency and efficient monitoring",
      "Version control with Git, using BitBucket / Jira",
      "Solution development using Scrum methodology",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Development and control of WMS (Warehouse Management System) services",
      "Use of Remote Desktop, Windows Services",
      "System, ETL, and dashboard development with C# and ASP.NET ecosystem",
